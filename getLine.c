 ...
 * Return: bytes read
 */
ssize_t input_buf(data *dat, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
 ...
 * Return: r
 */
ssize_t read_buf(data *dat, char *buf, size_t *i)
{
	ssize_t r = 0;
 ...
 * Return: s
 */
int _getline(data *dat, char **ptr, size_t *length)
{
